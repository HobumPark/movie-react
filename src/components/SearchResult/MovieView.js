...
function MovieView(){
    ...
    return(
        <div id='movie-view'>
            <div id='movie-info'>
                <div id='movie-cover'>
                    <a href={`/movie/slide?id=${movieDetail.movie_id}`}>
                        <img src={`/images/cover/movie${movieDetail.movie_id}.jpg`}/>
            ...
            <div id='movie-tab'>
                <div id='movie-tab-btn'>
                    <a href={`/movie/view/main?id=${movieDetail.movie_id}&menu=1`}
                    className={menu===1? 'tab_active':''}>주요정보</a>
                    <a href={`/movie/view/crew?id=${movieDetail.movie_id}&menu=2`}
                    className={menu===2? 'tab_active':''}>출연/제작</a>
                    <a href={`/movie/view/contents?id=${movieDetail.movie_id}&menu=3`}
                    className={menu===3? 'tab_active':''}>영상/포토</a>
                    <a href={`/movie/view/grade?id=${movieDetail.movie_id}&menu=4`}
